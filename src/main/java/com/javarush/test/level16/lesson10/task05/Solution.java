...
{
    private static byte countThreads = 3;
    private static List<Thread> threads = new ArrayList<>(countThreads);
    ...
    {
        final Water water = new Water("water");
    ...
    public static class Water implements Runnable
    {
        ...
        public void run()
        {
            ...
            final boolean isCurrentThreadInterrupted = current.isInterrupted();
