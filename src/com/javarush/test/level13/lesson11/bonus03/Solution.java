...
public class Solution
{
    ...
    {
        final Robot amigo = new Robot("Амиго");
        final Robot enemy = new Robot("Сгибальщик-02");
        doMove(amigo, enemy);
        doMove(amigo, enemy);
        doMove(enemy, amigo);
        doMove(amigo, enemy);
    ...
    public static void doMove(final Robot robotFirst, final Robot robotScond)
    {
        final BodyPart attacked = robotFirst.attack();
        final BodyPart defenced = robotFirst.defense();
        System.out.println(
