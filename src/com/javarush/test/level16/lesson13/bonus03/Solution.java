...
public class Solution
{
    ...
    {
        final Thread commonThread = new TestedThread(handler);
        final Thread threadA = new Thread(commonThread, "Нить 1");
        final Thread threadB = new Thread(commonThread, "Нить 2");
        threadA.start();
        threadB.start();
        threadA.interrupt();
        threadB.interrupt();
