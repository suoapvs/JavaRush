...
public class Solution
{
    ...
    public abstract static class Book
    {
        ...
        {
            final String agathaChristieOutput = author + ", " + getBook().getName() + " is a detective";
            final String markTwainOutput = getBook().getName() + " book was written by " + author;
    ...
    public static class MarkTwainBook extends Book
    {
        ...
        public MarkTwainBook(final String name)
        {
            super(author);
            this.name = name;
        }
    ...
    public static class AgathaChristieBook extends Book
    {
        ...
        public AgathaChristieBook(final String name)
        {
            super(author);
            this.name = name;
        }
